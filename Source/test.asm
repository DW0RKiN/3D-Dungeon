...
D227:CD5AEB	CALL EB5A
D22A:CDCFEA	CALL EACF
D22D:CDBCE7	CALL E7BC
...
E2A6:2845	JR Z, E2ED
E2A8:FE20	CP 20
E2AA:CA43EA	JP Z, EA43
E2AD:FE69	CP 69
E2AF:CAA8E7	JP Z, E7A8
E2B2:FE72	CP 72
...
E2C5:E1		POP HL
E2C6:CD20EA	CALL EA20
E2C9:C9		RET
E2CA:		label K_NOEXIT
E2CA:2173D4	LD HL, D473
E2CD:11B6E7	LD DE, E7B6
E2D0:D5		PUSH DE
E2D1:FE6B	CP 6B
...
E40D:CD20EA	CALL EA20
E410:C9		RET
E411:		label PRINT_PREPINAC
E411:CD08EA	CALL EA08
E414:1A		LD A, (DE)
E415:E61F	AND 1F
E417:CB3F	SRL A
E419:CB3F	SRL A
...
E794:C9		RET
E795:		label DE_INVENTORY_ITEMS_AKTIVNI_B0
E795:0600	LD B, 00
E797:		label DE_INVENTORY_ITEMS_AKTIVNI_B
E797:3A72D4	LD A, (D472)
E79A:5F		LD E, A
E79B:		label DE_INVENTORY_ITEMS_ABE
		IF (false)
...
E7A5:16D6	LD D, D6
		ENDIF
E7A7:C9		RET
E7A8:		label SET_RIGHT_PANEL
E7A8:2110D2	LD HL, D210
E7AB:7E		LD A, (HL)
E7AC:EE01	XOR 01
E7AE:77		LD (HL), A
E7AF:E601	AND 01
E7B1:C249E8	JP NZ, E849
E7B4:1806	JR E7BC
E7B6:		label NEW_PLAYER_ACTIVE
E7B6:CD8CE7	CALL E78C
E7B9:C249E8	JP NZ, E849
E7BC:		label PLAYERS_WINDOW
E7BC:01010E	LD BC, 0E01
E7BF:2112C8	LD HL, C812
E7C2:CD5AEB	CALL EB5A
E7C5:01030E	LD BC, 0E03
E7C8:21B2C8	LD HL, C8B2
E7CB:CD5AEB	CALL EB5A
E7CE:01030E	LD BC, 0E03
E7D1:2192C9	LD HL, C992
E7D4:CD5AEB	CALL EB5A
E7D7:01010E	LD BC, 0E01
E7DA:2172CA	LD HL, CA72
E7DD:CD5AEB	CALL EB5A
E7E0:DD210CDF	LD IX, DF0C
E7E4:ED4B72D4	LD BC, (D472)
E7E8:0C		INC C
E7E9:2112C8	LD HL, C812
E7EC:1119C8	LD DE, C819
E7EF:		label PW_JMENA_LOOP
E7EF:3E03	LD A, 03
E7F1:0D		DEC C
E7F2:2802	JR Z, E7F6
E7F4:3E07	LD A, 07
E7F6:		label PW_AKTIVNI
E7F6:F5		PUSH AF
E7F7:CDBDE3	CALL E3BD
E7FA:7D		LD A, L
E7FB:C6A0	ADD A, A0
E7FD:6F		LD L, A
E7FE:8C		ADC A, H
...
E801:F1		POP AF
E802:DDE5	PUSH IX
E804:DD2109DF	LD IX, DF09
E808:CDBDE3	CALL E3BD
E80B:DDE1	POP IX
E80D:7D		LD A, L
E80E:C640	ADD A, 40
E810:6F		LD L, A
...
E814:EB		EX DE, HL
E815:10D8	DJNZ E7EF
E817:DD2105D6	LD IX, D605
E81B:AF		XOR A
E81C:F5		PUSH AF
E81D:0E1F	LD C, 1F
E81F:		label PW_HANDS_LOOP
E81F:47		LD B, A
E820:DD7E14	LD A, (IX+14)
E823:CDE8E9	CALL E9E8
E826:04		INC B
E827:DD7E19	LD A, (IX+19)
E82A:CDE8E9	CALL E9E8
E82D:04		INC B
E82E:78		LD A, B
E82F:0600	LD B, 00
E831:DD09	ADD IX, BC
E833:FE0C	CP 0C
E835:C21FE8	JP NZ, E81F
E838:CD14E9	CALL E914
E83B:218DD4	LD HL, D48D
E83E:0606	LD B, 06
E840:		label PW_AVATARS
E840:CD5DE7	CALL E75D
E843:10FB	DJNZ E840
E845:CD7FEB	CALL EB7F
E848:C9		RET
E849:		label INVENTORY_WINDOW_OPEN
E849:		label INVENTORY_WINDOW_KURZOR
E849:		label INVENTORY_WINDOW_REFRESH
E849:010408	LD BC, 0804
E84C:2198C8	LD HL, C898
E84F:CD5AEB	CALL EB5A
E852:010808	LD BC, 0808
E855:2118C9	LD HL, C918
E858:CD5AEB	CALL EB5A
E85B:010408	LD BC, 0804
E85E:2118CA	LD HL, CA18
E861:CD5AEB	CALL EB5A
E864:01040A	LD BC, 0A04
E867:2116C8	LD HL, C816
E86A:CD5AEB	CALL EB5A
E86D:3A72D4	LD A, (D472)
E870:F5		PUSH AF
		IF (false)
...
E878:C60C	ADD A, 0C
E87A:DD6F	LD IXL, A
E87C:DD26DF	LD IXH, DF
		ENDIF
		IF (false)
-     .error 'Zmen kod protoze se NEXT_NAME != 11!'
		ENDIF
E87F:2116C8	LD HL, C816
E882:CD77E3	CALL E377
E885:F1		POP AF
E886:87		ADD A, A
E887:87		ADD A, A
E888:C68D	ADD A, 8D
...
E890:23		INC HL
E891:56		LD D, (HL)
E892:010012	LD BC, 1200
E895:CD85E0	CALL E085
E898:AF		XOR A
E899:F5		PUSH AF
E89A:061B	LD B, 1B
E89C:		label IW_LOOP
E89C:CDC0E8	CALL E8C0
E89F:10FB	DJNZ E89C
E8A1:11E386	LD DE, 86E3
E8A4:D5		PUSH DE
E8A5:11091D	LD DE, 1D09
E8A8:D5		PUSH DE
E8A9:11005F	LD DE, 5F00
E8AC:D5		PUSH DE
E8AD:110719	LD DE, 1907
E8B0:D5		PUSH DE
E8B1:11005F	LD DE, 5F00
E8B4:D5		PUSH DE
E8B5:11F81D	LD DE, 1DF8
E8B8:D5		PUSH DE
E8B9:CD14E9	CALL E914
E8BC:CD45E9	CALL E945
E8BF:C9		RET
E8C0:		label VYKRESLI_ITEM_NA_POZICI_B
E8C0:E1		POP HL
E8C1:2212E9	LD (E912), HL
E8C4:78		LD A, B
E8C5:87		ADD A, A
E8C6:C6FD	ADD A, FD
E8C8:6F		LD L, A
...
E8CF:66		LD H, (HL)
E8D0:6F		LD L, A
E8D1:3AFDD6	LD A, (D6FD)
E8D4:4F		LD C, A
E8D5:CDADE9	CALL E9AD
E8D8:2805	JR Z, E8DF
E8DA:110C87	LD DE, 870C
E8DD:D5		PUSH DE
E8DE:E5		PUSH HL
E8DF:		label IW_BEZ_MRIZKY
E8DF:48		LD C, B
E8E0:CD97E7	CALL E797
		IF (false)
...
E8E5:87		ADD A, A
E8E6:2806	JR Z, E8EE
E8E8:CD23E9	CALL E923
E8EB:D5		PUSH DE
E8EC:E5		PUSH HL
E8ED:0D		DEC C
E8EE:		label IW_BEZ_PREDMETU
E8EE:78		LD A, B
E8EF:FE11	CP 11
E8F1:2005	JR NZ, E8F8
E8F3:117784	LD DE, 8477
E8F6:D5		PUSH DE
E8F7:E5		PUSH HL
E8F8:		label IW_NENI_PROSTIRANI
E8F8:11B084	LD DE, 84B0
E8FB:3805	JR C, E902
E8FD:2803	JR Z, E902
E8FF:B9		CP C
E900:2803	JR Z, E905
E902:		label IW_MODRY
E902:114D81	LD DE, 814D
E905:		label IW_PRAZDNE_POLICKO
E905:3AFED6	LD A, (D6FE)
E908:3C		INC A
E909:B8		CP B
E90A:2003	JR NZ, E90F
E90C:118681	LD DE, 8186
E90F:		label IW_NEJSME_NA_KURZORU
E90F:D5		PUSH DE
E910:E5		PUSH HL
E911:		label VINPB_SELF
E911:C30000	JP 0000
E914:		label KRESLI_ZE_ZASOBNIKU
E914:E1		POP HL
E915:C1		POP BC
E916:04		INC B
E917:05		DEC B
...
E91A:D1		POP DE
E91B:E5		PUSH HL
E91C:CD85E0	CALL E085
E91F:18F3	JR E914
E921:		label KZZ_EXIT
E921:E5		PUSH HL
E922:C9		RET
E923:		label DE_2DSPRITE_A
E923:E5		PUSH HL
E924:C6BF	ADD A, BF
E926:6F		LD L, A
		IF (false)
...
E92C:E1		POP HL
E92D:C9		RET
E92E:		label A_NAJDI_POLOZENY_PREDMET_HL
E92E:E5		PUSH HL
E92F:C5		PUSH BC
E930:D5		PUSH DE
E931:CD6EE4	CALL E46E
E934:EB		EX DE, HL
E935:2B		DEC HL
E936:7E		LD A, (HL)
E937:2B		DEC HL
...
E943:E1		POP HL
E944:C9		RET
E945:		label VYKRESLI_AKTIVNI_PREDMET
E945:CD8CE7	CALL E78C
E948:C8		RET Z
E949:CD95E7	CALL E795
E94C:D5		PUSH DE
E94D:DDE1	POP IX
E94F:2A45D4	LD HL, (D445)
E952:CD2EE9	CALL E92E
E955:DD771C	LD (IX+1C), A
E958:24		INC H
E959:CD2EE9	CALL E92E
E95C:DD771E	LD (IX+1E), A
E95F:CD08E3	CALL E308
E962:25		DEC H
E963:CD2EE9	CALL E92E
E966:DD771B	LD (IX+1B), A
E969:25		DEC H
E96A:CD2EE9	CALL E92E
E96D:DD771D	LD (IX+1D), A
E970:AF		XOR A
E971:F5		PUSH AF
E972:061F	LD B, 1F
E974:		label VAP_LOOP
E974:CDC0E8	CALL E8C0
E977:05		DEC B
E978:3E1B	LD A, 1B
E97A:B8		CP B
E97B:20F7	JR NZ, E974
E97D:CD14E9	CALL E914
E980:3AFDD6	LD A, (D6FD)
E983:87		ADD A, A
E984:C8		RET Z
E985:C6BF	ADD A, BF
E987:6F		LD L, A
...
E99E:05		DEC B
E99F:0D		DEC C
E9A0:118681	LD DE, 8186
E9A3:C5		PUSH BC
E9A4:CD85E0	CALL E085
E9A7:C1		POP BC
E9A8:D1		POP DE
E9A9:CD85E0	CALL E085
E9AC:C9		RET
E9AD:		label TEST_NEPOVOLENE_POZICE
E9AD:78		LD A, B
E9AE:3D		DEC A
E9AF:FE1B	CP 1B
E9B1:380D	JR C, E9C0
...
E9B5:C8		RET Z
E9B6:E5		PUSH HL
E9B7:CD08E3	CALL E308
E9BA:26D1	LD H, D1
E9BC:CB46	BIT 0, (HL)
E9BE:E1		POP HL
E9BF:C9		RET
E9C0:		label TNP_NOSENE
E9C0:E6F0	AND F0
E9C2:C8		RET Z
E9C3:79		LD A, C
E9C4:B7		OR A
...
E9CE:78		LD A, B
E9CF:FE1B	CP 1B
E9D1:2002	JR NZ, E9D5
E9D3:3E16	LD A, 16
E9D5:		label TNP_NENI_PRSTEN
E9D5:FE1A	CP 1A
E9D7:2002	JR NZ, E9DB
E9D9:3E15	LD A, 15
E9DB:		label TNP_NENI_RUKA
E9DB:BE		CP (HL)
E9DC:E1		POP HL
E9DD:C9		RET
E9DE:		label DE_POZICE_RUKOU_A
		IF (false)
...
E9E6:56		LD D, (HL)
E9E7:C9		RET
E9E8:		label VYKRESLI_RUKU
E9E8:E1		POP HL
E9E9:2206EA	LD (EA06), HL
E9EC:11FD82	LD DE, 82FD
E9EF:87		ADD A, A
E9F0:2808	JR Z, E9FA
E9F2:C6BF	ADD A, BF
E9F4:6F		LD L, A
...
E9F8:2C		INC L
		ENDIF
E9F9:56		LD D, (HL)
E9FA:		label VR_PRAZDNA
E9FA:D5		PUSH DE
E9FB:78		LD A, B
E9FC:CDDEE9	CALL E9DE
E9FF:D5		PUSH DE
EA00:214D81	LD HL, 814D
EA03:E5		PUSH HL
EA04:D5		PUSH DE
EA05:		label VR_SELF
EA05:C30000	JP 0000
...
EA1A:D9		EXX
EA1B:E5		PUSH HL
EA1C:		label PUSH_ALL_HL
EA1C:210000	LD HL, 0000
EA1F:C9		RET
EA20:		label POP_ALL
EA20:E1		POP HL
EA21:D9		EXX
...
EA30:E3		EX (SP), HL
EA31:C9		RET
EA32:		label TIME_SCROLL
EA32:3A795C	LD A, (5C79)
EA35:E602	AND 02
EA37:47		LD B, A
EA38:		label TIME_SCROLL_LAST
EA38:EE00	XOR 00
EA3A:C8		RET Z
EA3B:78		LD A, B
EA3C:3239EA	LD (EA39), A
EA3F:CDC7E3	CALL E3C7
EA42:C9		RET
EA43:		label PREHOD_PREPINAC
EA43:CD8CE7	CALL E78C
EA46:CA99EA	JP Z, EA99
EA49:47		LD B, A
EA4A:04		INC B
EA4B:21FDD6	LD HL, D6FD
EA4E:4E		LD C, (HL)
EA4F:CDADE9	CALL E9AD
EA52:DD21D8DB	LD IX, DBD8
EA56:C2EAE3	JP NZ, E3EA
EA59:3E11	LD A, 11
EA5B:90		SUB B
EA5C:E5		PUSH HL
EA5D:CC26EB	CALL Z, EB26
EA60:05		DEC B
EA61:CD97E7	CALL E797
EA64:1A		LD A, (DE)
EA65:EB		EX DE, HL
EA66:71		LD (HL), C
EA67:E1		POP HL
EA68:77		LD (HL), A
EA69:C5		PUSH BC
EA6A:CD4AE4	CALL E44A
EA6D:C1		POP BC
EA6E:2AFDD6	LD HL, (D6FD)
EA71:7C		LD A, H
EA72:D61B	SUB 1B
EA74:DA49E8	JP C, E849
EA77:26EA	LD H, EA
EA79:C695	ADD A, 95
EA7B:6F		LD L, A
EA7C:46		LD B, (HL)
EA7D:2A45D4	LD HL, (D445)
EA80:CB48	BIT 1, B
EA82:C408E3	CALL NZ, E308
EA85:7C		LD A, H
EA86:80		ADD A, B
EA87:67		LD H, A
EA88:79		LD A, C
EA89:B7		OR A
EA8A:F5		PUSH AF
EA8B:C48BE4	CALL NZ, E48B
EA8E:F1		POP AF
EA8F:CCB7E4	CALL Z, E4B7
EA92:C349E8	JP E849
EA95:		label PP_DATA
EA95:03000201	DEFB of 4 bytes
EA99:		label PP_DATA_END
		IF (false)
-     .error 'PP_DATA!'
		ENDIF
EA99:		label PP_NEJSME_V_INVENTARI
EA99:CD08E3	CALL E308
EA9C:3E00	LD A, 00
EA9E:81		ADD A, C
EA9F:47		LD B, A
EAA0:CD54E4	CALL E454
EAA3:		label PP_NALEZEN_OBJEKT
EAA3:C0		RET NZ
EAA4:1A		LD A, (DE)
EAA5:E61F	AND 1F
EAA7:B8		CP B
...
EAAA:E61C	AND 1C
EAAC:FE0C	CP 0C
EAAE:CCFFE3	CALL Z, E3FF
EAB1:CD57E4	CALL E457
EAB4:18ED	JR EAA3
EAB6:		label PP_PROHOD_PAKU
		IF (false)
-     ld      A, (DE)                     ;  7:1 typ
...
-     ld      (de),a                      ;  7:1 typ
		ELSE (true)
EAB6:2680	LD H, 80
EAB8:CDDFE4	CALL E4DF
		ENDIF
EABB:13		INC DE
EABC:CD11E4	CALL E411
EABF:		label PP_LOOP
EABF:13		INC DE
EAC0:1A		LD A, (DE)
EAC1:B7		OR A
...
EAC7:1A		LD A, (DE)
EAC8:67		LD H, A
EAC9:CDDFE4	CALL E4DF
EACC:C3BFEA	JP EABF
EACF:		label HELP
EACF:DD2162DE	LD IX, DE62
EAD3:3E02	LD A, 02
EAD5:CDECE3	CALL E3EC
EAD8:CDEAE3	CALL E3EA
EADB:CDEAE3	CALL E3EA
EADE:CDEAE3	CALL E3EA
EAE1:C9		RET
EAE2:		label OBAL_SPRITE2BUFFER
EAE2:F5		PUSH AF
EAE3:E5		PUSH HL
EAE4:D5		PUSH DE
EAE5:CD85E0	CALL E085
EAE8:D1		POP DE
EAE9:E1		POP HL
EAEA:F1		POP AF
EAEB:C9		RET
EAEC:		label AKTUALIZUJ_RUZICI
EAEC:3A46D4	LD A, (D446)
EAEF:87		ADD A, A
EAF0:87		ADD A, A
EAF1:C6C9	ADD A, C9
EAF3:6F		LD L, A
...
EAF4:26D4	LD H, D4
		ENDIF
EAF6:CD5FE7	CALL E75F
EAF9:C9		RET
EAFA:		label AKTUALIZUJ_SIPKY
EAFA:C5		PUSH BC
EAFB:E5		PUSH HL
EAFC:6F		LD L, A
EAFD:CD68E0	CALL E068
EB00:7D		LD A, L
EB01:21A9D4	LD HL, D4A9
EB04:CD5FE7	CALL E75F
EB07:85		ADD A, L
EB08:6F		LD L, A
		IF (false)
...
-     ld      H, A                        ; 4:1 H + carry
		ENDIF
EB09:CD5FE7	CALL E75F
EB0C:CD5DE0	CALL E05D
EB0F:E1		POP HL
EB10:C1		POP BC
EB11:C9		RET
		IF (false)
...
EB26:		label EATING
EB26:C5		PUSH BC
EB27:3A72D4	LD A, (D472)
EB2A:CD34EC	CALL EC34
EB2D:23		INC HL
EB2E:46		LD B, (HL)
EB2F:115ADC	LD DE, DC5A
EB32:79		LD A, C
EB33:D61B	SUB 1B
EB35:200D	JR NZ, EB44
EB37:1166DC	LD DE, DC66
EB3A:2B		DEC HL
EB3B:7E		LD A, (HL)
EB3C:C614	ADD A, 14
EB3E:B8		CP B
...
EB42:77		LD (HL), A
EB43:AF		XOR A
EB44:		label E_NO_FOOD
EB44:3D		DEC A
EB45:2002	JR NZ, EB49
EB47:2B		DEC HL
EB48:70		LD (HL), B
EB49:		label E_NO_R
EB49:3D		DEC A
EB4A:2002	JR NZ, EB4E
EB4C:23		INC HL
EB4D:77		LD (HL), A
EB4E:		label E_NO_G
EB4E:3D		DEC A
EB4F:2000	JR NZ, EB51
EB51:		label E_NO_B
EB51:		label E_PRINT
EB51:EB		EX DE, HL
EB52:79		LD A, C
EB53:CD31E4	CALL E431
EB56:C1		POP BC
EB57:0E00	LD C, 00
EB59:C9		RET
EB5A:		label FILL_ATTR_BLOCK
EB5A:50		LD D, B
EB5B:1E07	LD E, 07
EB5D:0601	LD B, 01
EB5F:CD12EB	CALL EB12
EB62:25		DEC H
EB63:CD6EEB	CALL EB6E
EB66:1E00	LD E, 00
EB68:0608	LD B, 08
EB6A:CD12EB	CALL EB12
EB6D:C9		RET
		ENDIF
EB6E:		label SEG_ATTR2SCREEN
EB6E:7C		LD A, H
EB6F:26B0	LD H, B0
EB71:D6C8	SUB C8
EB73:3004	JR NC, EB79
EB75:2640	LD H, 40
EB77:C670	ADD A, 70
EB79:		label SA_BUFF
EB79:87		ADD A, A
...
EB7D:67		LD H, A
EB7E:C9		RET
EB7F:		label ZOBRAZ_ZIVOTY
EB7F:215BD7	LD HL, D75B
EB82:0606	LD B, 06
EB84:		label ZZ_LOOP
EB84:C5		PUSH BC
EB85:4E		LD C, (HL)
...
EB8B:2C		INC L
EB8C:56		LD D, (HL)
EB8D:CDCDEB	CALL EBCD
EB90:2C		INC L
EB91:4E		LD C, (HL)
EB92:2C		INC L
EB93:3A785C	LD A, (5C78)
EB96:B9		CP C
EB97:3802	JR C, EB9B
EB99:AF		XOR A
EB9A:77		LD (HL), A
EB9B:		label ZZ_NEVYPRSEL
EB9B:7E		LD A, (HL)
EB9C:B7		OR A
EB9D:2804	JR Z, EBA3
EB9F:47		LD B, A
EBA0:CDA8EB	CALL EBA8
EBA3:		label ZZ_BEZ_AKT_ZRANENI
EBA3:2C		INC L
EBA4:C1		POP BC
EBA5:10DD	DJNZ EB84
EBA7:C9		RET
EBA8:		label VYKRESLI_KRVAVY_FLEK
EBA8:E5		PUSH HL
EBA9:7A		LD A, D
EBAA:87		ADD A, A
EBAB:87		ADD A, A
...
EBB5:47		LD B, A
EBB6:D5		PUSH DE
EBB7:116770	LD DE, 7067
EBBA:CDE2EA	CALL EAE2
EBBD:E1		POP HL
EBBE:2C		INC L
EBBF:2C		INC L
EBC0:DD21CBEB	LD IX, EBCB
EBC4:3E42	LD A, 42
EBC6:CD79E3	CALL E379
EBC9:E1		POP HL
EBCA:C9		RET
EBCB:		label DAMAGE_BUF
EBCB:3100	DEFB of 2 bytes
EBCD:		label VYKRESLI_ZIVOTY
EBCD:E5		PUSH HL
EBCE:D5		PUSH DE
EBCF:D5		PUSH DE
EBD0:AF		XOR A
...
EBDB:0D		DEC C
EBDC:ED52	SBC HL, DE
EBDE:30FB	JR NC, EBDB
EBE0:ED5A	ADC HL, DE
EBE2:29		ADD HL, HL
EBE3:29		ADD HL, HL
EBE4:29		ADD HL, HL
EBE5:		label VZ_ZBYTEK
EBE5:3C		INC A
EBE6:ED52	SBC HL, DE
EBE8:30FB	JR NC, EBE5
		IF (false)
...
EBF0:79		LD A, C
EBF1:3C		INC A
EBF2:2002	JR NZ, EBF6
EBF4:3E42	LD A, 42
EBF6:		label VZ_VICEZNAKOVY
EBF6:E646	AND 46
EBF8:5F		LD E, A
EBF9:E1		POP HL
EBFA:0605	LD B, 05
EBFC:		label VZ_LOOP_SELF
EBFC:7A		LD A, D
EBFD:0C		INC C
EBFE:2803	JR Z, EC03
EC00:79		LD A, C
EC01:17		RLA
EC02:9F		SBC A, A
EC03:		label VZ_PREDEL
EC03:		label VZ_COL_SELF
EC03:73		LD (HL), E
EC04:E5		PUSH HL
EC05:C5		PUSH BC
EC06:4F		LD C, A
EC07:CD6EEB	CALL EB6E
EC0A:0606	LD B, 06
EC0C:		label VZ_LOOP_PX
EC0C:24		INC H
EC0D:71		LD (HL), C
EC0E:10FC	DJNZ EC0C
EC10:C1		POP BC
...
EC16:E1		POP HL
EC17:C9		RET
EC18:		label VYHAZEJ_VSECHNO
EC18:C5		PUSH BC
EC19:D5		PUSH DE
EC1A:7B		LD A, E
EC1B:061B	LD B, 1B
EC1D:CD9BE7	CALL E79B
EC20:		label VV_LOOP
		IF (false)
...
EC21:D5		PUSH DE
EC22:C5		PUSH BC
EC23:2A45D4	LD HL, (D445)
EC26:1A		LD A, (DE)
EC27:B7		OR A
EC28:C48BE4	CALL NZ, E48B
EC2B:C1		POP BC
EC2C:D1		POP DE
EC2D:AF		XOR A
EC2E:12		LD (DE), A
...
EC3C:26D7	LD H, D7
EC3E:C9		RET
EC3F:		label ZRAN_POSTAVU
EC3F:D5		PUSH DE
EC40:7B		LD A, E
EC41:CD34EC	CALL EC34
EC44:7E		LD A, (HL)
EC45:92		SUB D
EC46:3007	JR NC, EC4F
EC48:AF		XOR A
EC49:77		LD (HL), A
EC4A:CD18EC	CALL EC18
EC4D:180E	JR EC5D
EC4F:		label ZP_ZIJE
EC4F:77		LD (HL), A
EC50:23		INC HL
...
EC5D:D1		POP DE
EC5E:C9		RET
EC5F:		label OTESTUJ_TRVALE_ZRANENI
EC5F:D5		PUSH DE
EC60:7B		LD A, E
EC61:CD34EC	CALL EC34
EC64:23		INC HL
EC65:23		INC HL
EC66:7E		LD A, (HL)
EC67:B7		OR A
EC68:57		LD D, A
EC69:C43FEC	CALL NZ, EC3F
EC6C:D1		POP DE
EC6D:C9		RET
EC6E:		label PLAYERS_WINDOW_AND_DAMAGE
EC6E:		label PWAD_SELF
EC6E:3E00	LD A, 00
EC70:21785C	LD HL, 5C78
EC73:AE		XOR (HL)
EC74:E680	AND 80
EC76:280F	JR Z, EC87
EC78:7E		LD A, (HL)
EC79:326FEC	LD (EC6F), A
EC7C:110001	LD DE, 0100
EC7F:0606	LD B, 06
EC81:		label PWAD_LOOP
EC81:CD5FEC	CALL EC5F
EC84:1C		INC E
EC85:10FA	DJNZ EC81
EC87:		label PWAD_NEZRANUJ
EC87:CDBCE7	CALL E7BC
EC8A:C9		RET
EC8B:		label BUFF2SCREEN
EC8B:CD08EA	CALL EA08
EC8E:AF		XOR A
EC8F:D3FE	OUT (FE), A
EC91:2100C8	LD HL, C800
EC94:22FAEC	LD (ECFA), HL
EC97:76		HALT
EC98:F3		DI
EC99:210602	LD HL, 0206
EC9C:		label B2S_WAIT
EC9C:2B		DEC HL
EC9D:7C		LD A, H
EC9E:B5		OR L
EC9F:20FB	JR NZ, EC9C
ECA1:4D		LD C, L
ECA2:39		ADD HL, SP
ECA3:2239ED	LD (ED39), HL
ECA6:0608	LD B, 08
ECA8:2110B0	LD HL, B010
ECAB:1804	JR ECB1
ECAD:		label B2S_PIXEL_DOWN_LOOP
ECAD:211071	LD HL, 7110
ECB0:		label B2S_CHAR_DOWN_LOOP
ECB0:39		ADD HL, SP
ECB1:		label B2S_DIRECT
ECB1:F9		LD SP, HL
ECB2:F1		POP AF
ECB3:D1		POP DE
ECB4:E1		POP HL
...
ECCD:D5		PUSH DE
ECCE:F5		PUSH AF
ECCF:ED73E4EC	LD (ECE4), SP
ECD3:21F06F	LD HL, 6FF0
ECD6:39		ADD HL, SP
ECD7:F9		LD SP, HL
ECD8:F1		POP AF
ECD9:D1		POP DE
...
ECE1:C1		POP BC
ECE2:F1		POP AF
ECE3:		label B2S_SELF_DIRECT
ECE3:310000	LD SP, 0000
ECE6:F5		PUSH AF
ECE7:C5		PUSH BC
ECE8:D5		PUSH DE
ECE9:E5		PUSH HL
...
ECF0:F5		PUSH AF
ECF1:10BA	DJNZ ECAD
ECF3:ED7320ED	LD (ED20), SP
ECF7:0602	LD B, 02
ECF9:		label B2S_ATTR_LOOP
ECF9:		label B2S_SELF_SRC
ECF9:3100C8	LD SP, C800
ECFC:F1		POP AF
ECFD:D1		POP DE
ECFE:E1		POP HL
ECFF:D9		EXX
...
ED05:D1		POP DE
ED06:C1		POP BC
ED07:210290	LD HL, 9002
ED0A:39		ADD HL, SP
ED0B:F1		POP AF
ED0C:ED73FAEC	LD (ECFA), SP
ED10:F9		LD SP, HL
ED11:F5		PUSH AF
ED12:C5		PUSH BC
ED13:D5		PUSH DE
...
ED1C:F5		PUSH AF
ED1D:10DA	DJNZ ECF9
ED1F:		label B2S_ATTR_SELF
ED1F:310000	LD SP, 0000
ED22:0C		INC C
ED23:213069	LD HL, 6930
ED26:79		LD A, C
ED27:FE14	CP 14
ED29:280D	JR Z, ED38
ED2B:0608	LD B, 08
ED2D:E607	AND 07
ED2F:C2B0EC	JP NZ, ECB0
ED32:213070	LD HL, 7030
ED35:C3B0EC	JP ECB0
ED38:		label B2S_EXIT
ED38:		label B2S_SELF
ED38:310000	LD SP, 0000
ED3B:FB		EI
ED3C:CD20EA	CALL EA20
ED3F:C9		RET
		INCLUDE table.h
i_nw		EQU 0000
i_ne		EQU 0001
...
ED40:		label ADR_ZARAZKY
ED40:5CEE	DEFW of 1 words
ED42:		label TABLE_OBJECTS
ED42:010C00	DEFB of 3 bytes
ED45:060C01	DEFB of 3 bytes
ED48:101019	DEFB of 3 bytes
ED4B:101114	DEFB of 3 bytes
ED4E:101219	DEFB of 3 bytes
ED51:101316	DEFB of 3 bytes
ED54:11101A	DEFB of 3 bytes
ED57:111117	DEFB of 3 bytes
ED5A:11120A	DEFB of 3 bytes
ED5D:11130B	DEFB of 3 bytes
ED60:158980	DEFB of 3 bytes
ED63:201015	DEFB of 3 bytes
ED66:201113	DEFB of 3 bytes
ED69:201218	DEFB of 3 bytes
ED6C:201311	DEFB of 3 bytes
ED6F:21100C	DEFB of 3 bytes
ED72:211106	DEFB of 3 bytes
ED75:211207	DEFB of 3 bytes
ED78:211317	DEFB of 3 bytes
ED7B:301019	DEFB of 3 bytes
ED7E:321204	DEFB of 3 bytes
ED81:321302	DEFB of 3 bytes
ED84:40101A	DEFB of 3 bytes
ED87:40111A	DEFB of 3 bytes
ED8A:40121A	DEFB of 3 bytes
ED8D:40131A	DEFB of 3 bytes
ED90:421010	DEFB of 3 bytes
ED93:42111C	DEFB of 3 bytes
ED96:42121D	DEFB of 3 bytes
ED99:42131E	DEFB of 3 bytes
ED9C:448980	DEFB of 3 bytes
ED9F:50101A	DEFB of 3 bytes
EDA2:50111A	DEFB of 3 bytes
EDA5:50121A	DEFB of 3 bytes
EDA8:50131A	DEFB of 3 bytes
EDAB:521012	DEFB of 3 bytes
EDAE:521108	DEFB of 3 bytes
EDB1:52121B	DEFB of 3 bytes
EDB4:52131D	DEFB of 3 bytes
EDB7:578401	DEFB of 3 bytes
EDBA:571016	DEFB of 3 bytes
EDBD:57101D	DEFB of 3 bytes
EDC0:57101D	DEFB of 3 bytes
EDC3:57101D	DEFB of 3 bytes
EDC6:578500	DEFB of 3 bytes
EDC9:578700	DEFB of 3 bytes
EDCC:57131A	DEFB of 3 bytes
EDCF:571311	DEFB of 3 bytes
EDD2:590100	DEFB of 3 bytes
EDD5:005784	DEFB of 3 bytes
EDD8:5F0C00	DEFB of 3 bytes
EDDB:738C00	DEFB of 3 bytes
EDDE:73121D	DEFB of 3 bytes
EDE1:778401	DEFB of 3 bytes
EDE4:778500	DEFB of 3 bytes
EDE7:778700	DEFB of 3 bytes
EDEA:810C01	DEFB of 3 bytes
EDED:840200	DEFB of 3 bytes
EDF0:007784	DEFB of 3 bytes
EDF3:8E8400	DEFB of 3 bytes
EDF6:8E8400	DEFB of 3 bytes
EDF9:8E8600	DEFB of 3 bytes
EDFC:9EE400	DEFB of 3 bytes
EDFF:9EE400	DEFB of 3 bytes
EE02:9EE600	DEFB of 3 bytes
EE05:B00C00	DEFB of 3 bytes
PAKA_A		EQU 00B9
PAKA_B		EQU 00BA
PAKA_C		EQU 00BB
PAKA_D		EQU 00BC
EE08:B90200	DEFB of 3 bytes
EE0B:008E84	DEFB of 3 bytes
EE0E:009EE4	DEFB of 3 bytes
EE11:00BA82	DEFB of 3 bytes
EE14:00BB82	DEFB of 3 bytes
EE17:00BC82	DEFB of 3 bytes
EE1A:BA0200	DEFB of 3 bytes
EE1D:009EC4	DEFB of 3 bytes
EE20:00BB82	DEFB of 3 bytes
EE23:BB0200	DEFB of 3 bytes
EE26:009E64	DEFB of 3 bytes
EE29:00BC82	DEFB of 3 bytes
EE2C:BC0200	DEFB of 3 bytes
EE2F:009EA4	DEFB of 3 bytes
EE32:00BA82	DEFB of 3 bytes
EE35:D80100	DEFB of 3 bytes
		IF (false)
- defb      0,                           216,      ZAM_1 + TYP_PREPINAC + west    ; prepne i paku na druhe strane
		ENDIF
EE38:00E884	DEFB of 3 bytes
EE3B:D80300	DEFB of 3 bytes
		IF (false)
- defb      0,                           216,      ZAM_1 + TYP_PREPINAC + east    ; prepne i paku na druhe strane
		ENDIF
EE3E:00E884	DEFB of 3 bytes
EE41:E88401	DEFB of 3 bytes
EE44:E88500	DEFB of 3 bytes
EE47:E88700	DEFB of 3 bytes
EE4A:F60C01	DEFB of 3 bytes
EE4D:F6101D	DEFB of 3 bytes
EE50:F6111C	DEFB of 3 bytes
EE53:F6121D	DEFB of 3 bytes
EE56:F6131D	DEFB of 3 bytes
EE59:FE0C00	DEFB of 3 bytes
EE5C:		label ZARAZKA
EE5C:FF		DEFB of 1 bytes
		End of INCLUDE
EE5D:		label END_CODE
		IF (false)
-     .error 'Kod preteka do zasobniku.'
		ENDIF
Emiting raw binary from 5F00 to EE5C
