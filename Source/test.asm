...
EB50:CD50EC	CALL EC50
EB53:23		INC HL
EB54:115EDC	LD DE, DC5E
EB57:79		LD A, C
EB58:D61B	SUB 1B
EB5A:2003	JR NZ, EB5F
EB5C:116ADC	LD DE, DC6A
EB5F:		label E_NO_FOOD
EB5F:3D		DEC A
EB60:2003	JR NZ, EB65
EB62:46		LD B, (HL)
EB63:2B		DEC HL
EB64:70		LD (HL), B
EB65:		label E_NO_R
EB65:3D		DEC A
EB66:2002	JR NZ, EB6A
EB68:23		INC HL
EB69:77		LD (HL), A
EB6A:		label E_NO_G
EB6A:3D		DEC A
EB6B:2000	JR NZ, EB6D
EB6D:		label E_NO_B
EB6D:		label E_PRINT
EB6D:EB		EX DE, HL
EB6E:79		LD A, C
EB6F:CD2CE4	CALL E42C
EB72:C1		POP BC
EB73:0E00	LD C, 00
EB75:C9		RET
EB76:		label FILL_ATTR_BLOCK
EB76:50		LD D, B
EB77:1E07	LD E, 07
EB79:0601	LD B, 01
EB7B:CD38EB	CALL EB38
EB7E:25		DEC H
EB7F:CD8AEB	CALL EB8A
EB82:1E00	LD E, 00
EB84:0608	LD B, 08
EB86:CD38EB	CALL EB38
EB89:C9		RET
		ENDIF
EB8A:		label SEG_ATTR2SCREEN
EB8A:7C		LD A, H
EB8B:26B0	LD H, B0
EB8D:D6C8	SUB C8
EB8F:3004	JR NC, EB95
EB91:2640	LD H, 40
EB93:C670	ADD A, 70
EB95:		label SA_BUFF
EB95:87		ADD A, A
...
EB99:67		LD H, A
EB9A:C9		RET
EB9B:		label ZOBRAZ_ZIVOTY
EB9B:215BD7	LD HL, D75B
EB9E:0606	LD B, 06
EBA0:		label ZZ_LOOP
EBA0:C5		PUSH BC
EBA1:4E		LD C, (HL)
...
EBA7:2C		INC L
EBA8:56		LD D, (HL)
EBA9:CDE9EB	CALL EBE9
EBAC:2C		INC L
EBAD:4E		LD C, (HL)
EBAE:2C		INC L
EBAF:3A785C	LD A, (5C78)
EBB2:B9		CP C
EBB3:3802	JR C, EBB7
EBB5:AF		XOR A
EBB6:77		LD (HL), A
EBB7:		label ZZ_NEVYPRSEL
EBB7:7E		LD A, (HL)
EBB8:B7		OR A
EBB9:2804	JR Z, EBBF
EBBB:47		LD B, A
EBBC:CDC4EB	CALL EBC4
EBBF:		label ZZ_BEZ_AKT_ZRANENI
EBBF:2C		INC L
EBC0:C1		POP BC
EBC1:10DD	DJNZ EBA0
EBC3:C9		RET
EBC4:		label VYKRESLI_KRVAVY_FLEK
EBC4:E5		PUSH HL
EBC5:7A		LD A, D
EBC6:87		ADD A, A
EBC7:87		ADD A, A
...
EBD1:47		LD B, A
EBD2:D5		PUSH DE
EBD3:116770	LD DE, 7067
EBD6:CD04EB	CALL EB04
EBD9:E1		POP HL
EBDA:2C		INC L
EBDB:2C		INC L
EBDC:DD21E7EB	LD IX, EBE7
EBE0:3E42	LD A, 42
EBE2:CD74E3	CALL E374
EBE5:E1		POP HL
EBE6:C9		RET
EBE7:		label DAMAGE_BUF
EBE7:3100	DEFB of 2 bytes
EBE9:		label VYKRESLI_ZIVOTY
EBE9:E5		PUSH HL
EBEA:D5		PUSH DE
EBEB:D5		PUSH DE
EBEC:AF		XOR A
...
EBF7:0D		DEC C
EBF8:ED52	SBC HL, DE
EBFA:30FB	JR NC, EBF7
EBFC:ED5A	ADC HL, DE
EBFE:29		ADD HL, HL
EBFF:29		ADD HL, HL
EC00:29		ADD HL, HL
EC01:		label VZ_ZBYTEK
EC01:3C		INC A
EC02:ED52	SBC HL, DE
...
EC0C:79		LD A, C
EC0D:3C		INC A
EC0E:2002	JR NZ, EC12
EC10:3E42	LD A, 42
EC12:		label VZ_VICEZNAKOVY
EC12:E646	AND 46
EC14:5F		LD E, A
EC15:E1		POP HL
EC16:0605	LD B, 05
EC18:		label VZ_LOOP_SELF
EC18:7A		LD A, D
EC19:0C		INC C
EC1A:2803	JR Z, EC1F
EC1C:79		LD A, C
EC1D:17		RLA
EC1E:9F		SBC A, A
EC1F:		label VZ_PREDEL
EC1F:		label VZ_COL_SELF
EC1F:73		LD (HL), E
EC20:E5		PUSH HL
EC21:C5		PUSH BC
EC22:4F		LD C, A
EC23:CD8AEB	CALL EB8A
EC26:0606	LD B, 06
EC28:		label VZ_LOOP_PX
EC28:24		INC H
EC29:71		LD (HL), C
EC2A:10FC	DJNZ EC28
EC2C:C1		POP BC
...
EC32:E1		POP HL
EC33:C9		RET
EC34:		label VYHAZEJ_VSECHNO
EC34:C5		PUSH BC
EC35:D5		PUSH DE
EC36:7B		LD A, E
EC37:CD8EE7	CALL E78E
EC3A:061B	LD B, 1B
EC3C:		label VV_LOOP
EC3C:D5		PUSH DE
EC3D:C5		PUSH BC
EC3E:2A45D4	LD HL, (D445)
EC41:1A		LD A, (DE)
EC42:B7		OR A
EC43:C486E4	CALL NZ, E486
EC46:C1		POP BC
EC47:D1		POP DE
EC48:AF		XOR A
EC49:12		LD (DE), A
...
EC58:26D7	LD H, D7
EC5A:C9		RET
EC5B:		label ZRAN_POSTAVU
EC5B:D5		PUSH DE
EC5C:7B		LD A, E
EC5D:CD50EC	CALL EC50
EC60:7E		LD A, (HL)
EC61:92		SUB D
EC62:3007	JR NC, EC6B
EC64:AF		XOR A
EC65:77		LD (HL), A
EC66:CD34EC	CALL EC34
EC69:180E	JR EC79
EC6B:		label ZP_ZIJE
EC6B:77		LD (HL), A
EC6C:23		INC HL
...
EC79:D1		POP DE
EC7A:C9		RET
EC7B:		label OTESTUJ_TRVALE_ZRANENI
EC7B:D5		PUSH DE
EC7C:7B		LD A, E
EC7D:CD50EC	CALL EC50
EC80:23		INC HL
EC81:23		INC HL
EC82:7E		LD A, (HL)
EC83:B7		OR A
EC84:57		LD D, A
EC85:C45BEC	CALL NZ, EC5B
EC88:D1		POP DE
EC89:C9		RET
EC8A:		label PLAYERS_WINDOW_AND_DAMAGE
EC8A:		label PWAD_SELF
EC8A:3E00	LD A, 00
EC8C:21785C	LD HL, 5C78
EC8F:AE		XOR (HL)
EC90:E680	AND 80
EC92:280F	JR Z, ECA3
EC94:7E		LD A, (HL)
EC95:328BEC	LD (EC8B), A
EC98:110001	LD DE, 0100
EC9B:0606	LD B, 06
EC9D:		label PWAD_LOOP
EC9D:CD7BEC	CALL EC7B
ECA0:1C		INC E
ECA1:10FA	DJNZ EC9D
ECA3:		label PWAD_NEZRANUJ
ECA3:CDAEE7	CALL E7AE
ECA6:C9		RET
ECA7:		label BUFF2SCREEN
ECA7:CD23EA	CALL EA23
ECAA:AF		XOR A
ECAB:D3FE	OUT (FE), A
ECAD:2100C8	LD HL, C800
ECB0:2216ED	LD (ED16), HL
ECB3:76		HALT
ECB4:F3		DI
ECB5:210602	LD HL, 0206
ECB8:		label B2S_WAIT
ECB8:2B		DEC HL
ECB9:7C		LD A, H
ECBA:B5		OR L
ECBB:20FB	JR NZ, ECB8
ECBD:4D		LD C, L
ECBE:39		ADD HL, SP
ECBF:2255ED	LD (ED55), HL
ECC2:0608	LD B, 08
ECC4:2110B0	LD HL, B010
ECC7:1804	JR ECCD
ECC9:		label B2S_PIXEL_DOWN_LOOP
ECC9:211071	LD HL, 7110
ECCC:		label B2S_CHAR_DOWN_LOOP
ECCC:39		ADD HL, SP
ECCD:		label B2S_DIRECT
ECCD:F9		LD SP, HL
ECCE:F1		POP AF
ECCF:D1		POP DE
ECD0:E1		POP HL
...
ECE9:D5		PUSH DE
ECEA:F5		PUSH AF
ECEB:ED7300ED	LD (ED00), SP
ECEF:21F06F	LD HL, 6FF0
ECF2:39		ADD HL, SP
ECF3:F9		LD SP, HL
ECF4:F1		POP AF
ECF5:D1		POP DE
...
ECFD:C1		POP BC
ECFE:F1		POP AF
ECFF:		label B2S_SELF_DIRECT
ECFF:310000	LD SP, 0000
ED02:F5		PUSH AF
ED03:C5		PUSH BC
ED04:D5		PUSH DE
ED05:E5		PUSH HL
...
ED0C:F5		PUSH AF
ED0D:10BA	DJNZ ECC9
ED0F:ED733CED	LD (ED3C), SP
ED13:0602	LD B, 02
ED15:		label B2S_ATTR_LOOP
ED15:		label B2S_SELF_SRC
ED15:3100C8	LD SP, C800
ED18:F1		POP AF
ED19:D1		POP DE
ED1A:E1		POP HL
ED1B:D9		EXX
...
ED21:D1		POP DE
ED22:C1		POP BC
ED23:210290	LD HL, 9002
ED26:39		ADD HL, SP
ED27:F1		POP AF
ED28:ED7316ED	LD (ED16), SP
ED2C:F9		LD SP, HL
ED2D:F5		PUSH AF
ED2E:C5		PUSH BC
ED2F:D5		PUSH DE
...
ED38:F5		PUSH AF
ED39:10DA	DJNZ ED15
ED3B:		label B2S_ATTR_SELF
ED3B:310000	LD SP, 0000
ED3E:0C		INC C
ED3F:213069	LD HL, 6930
ED42:79		LD A, C
ED43:FE14	CP 14
ED45:280D	JR Z, ED54
ED47:0608	LD B, 08
ED49:E607	AND 07
ED4B:C2CCEC	JP NZ, ECCC
ED4E:213070	LD HL, 7030
ED51:C3CCEC	JP ECCC
ED54:		label B2S_EXIT
ED54:		label B2S_SELF
ED54:310000	LD SP, 0000
ED57:FB		EI
ED58:CD3DEA	CALL EA3D
ED5B:C9		RET
		INCLUDE table.h
i_nw		EQU 0000
i_ne		EQU 0001
...
ED5C:		label ADR_ZARAZKY
ED5C:78EE	DEFW of 1 words
ED5E:		label TABLE_OBJECTS
ED5E:010C00	DEFB of 3 bytes
ED61:060C01	DEFB of 3 bytes
ED64:101019	DEFB of 3 bytes
ED67:101114	DEFB of 3 bytes
ED6A:101219	DEFB of 3 bytes
ED6D:101316	DEFB of 3 bytes
ED70:11101A	DEFB of 3 bytes
ED73:111117	DEFB of 3 bytes
ED76:11120A	DEFB of 3 bytes
ED79:11130B	DEFB of 3 bytes
ED7C:158980	DEFB of 3 bytes
ED7F:201015	DEFB of 3 bytes
ED82:201113	DEFB of 3 bytes
ED85:201218	DEFB of 3 bytes
ED88:201311	DEFB of 3 bytes
ED8B:21100C	DEFB of 3 bytes
ED8E:211106	DEFB of 3 bytes
ED91:211207	DEFB of 3 bytes
ED94:211317	DEFB of 3 bytes
ED97:301019	DEFB of 3 bytes
ED9A:321204	DEFB of 3 bytes
ED9D:321302	DEFB of 3 bytes
EDA0:40101A	DEFB of 3 bytes
EDA3:40111A	DEFB of 3 bytes
EDA6:40121A	DEFB of 3 bytes
EDA9:40131A	DEFB of 3 bytes
EDAC:421010	DEFB of 3 bytes
EDAF:42111C	DEFB of 3 bytes
EDB2:42121D	DEFB of 3 bytes
EDB5:42131E	DEFB of 3 bytes
EDB8:448980	DEFB of 3 bytes
EDBB:50101A	DEFB of 3 bytes
EDBE:50111A	DEFB of 3 bytes
EDC1:50121A	DEFB of 3 bytes
EDC4:50131A	DEFB of 3 bytes
EDC7:521012	DEFB of 3 bytes
EDCA:521108	DEFB of 3 bytes
EDCD:52121B	DEFB of 3 bytes
EDD0:52131D	DEFB of 3 bytes
EDD3:578401	DEFB of 3 bytes
EDD6:571016	DEFB of 3 bytes
EDD9:57101D	DEFB of 3 bytes
EDDC:57101D	DEFB of 3 bytes
EDDF:57101D	DEFB of 3 bytes
EDE2:578500	DEFB of 3 bytes
EDE5:578700	DEFB of 3 bytes
EDE8:57131A	DEFB of 3 bytes
EDEB:571311	DEFB of 3 bytes
EDEE:590100	DEFB of 3 bytes
EDF1:005784	DEFB of 3 bytes
EDF4:5F0C00	DEFB of 3 bytes
EDF7:738C00	DEFB of 3 bytes
EDFA:73121D	DEFB of 3 bytes
EDFD:778401	DEFB of 3 bytes
EE00:778500	DEFB of 3 bytes
EE03:778700	DEFB of 3 bytes
EE06:810C01	DEFB of 3 bytes
EE09:840200	DEFB of 3 bytes
EE0C:007784	DEFB of 3 bytes
EE0F:8E8400	DEFB of 3 bytes
EE12:8E8400	DEFB of 3 bytes
EE15:8E8600	DEFB of 3 bytes
EE18:9EE400	DEFB of 3 bytes
EE1B:9EE400	DEFB of 3 bytes
EE1E:9EE600	DEFB of 3 bytes
EE21:B00C00	DEFB of 3 bytes
PAKA_A		EQU 00B9
PAKA_B		EQU 00BA
PAKA_C		EQU 00BB
PAKA_D		EQU 00BC
EE24:B90200	DEFB of 3 bytes
EE27:008E84	DEFB of 3 bytes
EE2A:009EE4	DEFB of 3 bytes
EE2D:00BA82	DEFB of 3 bytes
EE30:00BB82	DEFB of 3 bytes
EE33:00BC82	DEFB of 3 bytes
EE36:BA0200	DEFB of 3 bytes
EE39:009EC4	DEFB of 3 bytes
EE3C:00BB82	DEFB of 3 bytes
EE3F:BB0200	DEFB of 3 bytes
EE42:009E64	DEFB of 3 bytes
EE45:00BC82	DEFB of 3 bytes
EE48:BC0200	DEFB of 3 bytes
EE4B:009EA4	DEFB of 3 bytes
EE4E:00BA82	DEFB of 3 bytes
EE51:D80100	DEFB of 3 bytes
		IF (false)
- defb      0,                           216,      ZAM_1 + TYP_PREPINAC + west    ; prepne i paku na druhe strane
		ENDIF
EE54:00E884	DEFB of 3 bytes
EE57:D80300	DEFB of 3 bytes
		IF (false)
- defb      0,                           216,      ZAM_1 + TYP_PREPINAC + east    ; prepne i paku na druhe strane
		ENDIF
EE5A:00E884	DEFB of 3 bytes
EE5D:E88401	DEFB of 3 bytes
EE60:E88500	DEFB of 3 bytes
EE63:E88700	DEFB of 3 bytes
EE66:F60C01	DEFB of 3 bytes
EE69:F6101D	DEFB of 3 bytes
EE6C:F6111C	DEFB of 3 bytes
EE6F:F6121D	DEFB of 3 bytes
EE72:F6131D	DEFB of 3 bytes
EE75:FE0C00	DEFB of 3 bytes
EE78:		label ZARAZKA
EE78:FF		DEFB of 1 bytes
		End of INCLUDE
EE79:		label END_CODE
		IF (false)
-     .error 'Kod preteka do zasobniku.'
		ENDIF
Emiting raw binary from 5F00 to EE78
