...
D227:CDD6EB	CALL EBD6
D22A:CD4BEB	CALL EB4B
...
E482:CD9CEA	CALL EA9C
E485:C9		RET
E486:		label PRINT_PREPINAC
E486:CD84EA	CALL EA84
E489:1A		LD A, (DE)
E48A:E61F	AND 1F
E48C:CB3F	SRL A
E48E:CB3F	SRL A
...
E898:CD64EA	CALL EA64
E89B:04		INC B
E89C:DD7E19	LD A, (IX+19)
E89F:CD64EA	CALL EA64
E8A2:04		INC B
E8A3:78		LD A, B
E8A4:0600	LD B, 00
E8A6:DD09	ADD IX, BC
...
EA14:79		LD A, C
EA15:D620	SUB 20
EA17:3002	JR NC, EA1B
EA19:DE08	SBC A, 08
EA1B:		label VAP_V_TRETINE
EA1B:4F		LD C, A
EA1C:117C81	LD DE, 817C
EA1F:C5		PUSH BC
EA20:CD91E0	CALL E091
EA23:C1		POP BC
EA24:D1		POP DE
EA25:CD91E0	CALL E091
EA28:C9		RET
EA29:		label TEST_NEPOVOLENE_POZICE
EA29:78		LD A, B
EA2A:3D		DEC A
EA2B:FE1B	CP 1B
EA2D:380D	JR C, EA3C
...
EA31:C8		RET Z
EA32:E5		PUSH HL
EA33:CD7DE3	CALL E37D
EA36:26D1	LD H, D1
EA38:CB46	BIT 0, (HL)
EA3A:E1		POP HL
EA3B:C9		RET
EA3C:		label TNP_NOSENE
EA3C:E6F0	AND F0
EA3E:C8		RET Z
EA3F:79		LD A, C
EA40:B7		OR A
...
EA4A:78		LD A, B
EA4B:FE1B	CP 1B
EA4D:2002	JR NZ, EA51
EA4F:3E16	LD A, 16
EA51:		label TNP_NENI_PRSTEN
EA51:FE1A	CP 1A
EA53:2002	JR NZ, EA57
EA55:3E15	LD A, 15
EA57:		label TNP_NENI_RUKA
EA57:BE		CP (HL)
EA58:E1		POP HL
EA59:C9		RET
EA5A:		label DE_POZICE_RUKOU_A
		IF (false)
...
EA62:56		LD D, (HL)
EA63:C9		RET
EA64:		label VYKRESLI_RUKU
EA64:E1		POP HL
EA65:2282EA	LD (EA82), HL
EA68:11F382	LD DE, 82F3
EA6B:87		ADD A, A
EA6C:2808	JR Z, EA76
EA6E:C6BF	ADD A, BF
EA70:6F		LD L, A
...
EA74:2C		INC L
		ENDIF
EA75:56		LD D, (HL)
EA76:		label VR_PRAZDNA
EA76:D5		PUSH DE
EA77:78		LD A, B
EA78:CD5AEA	CALL EA5A
EA7B:D5		PUSH DE
EA7C:214381	LD HL, 8143
EA7F:E5		PUSH HL
EA80:D5		PUSH DE
EA81:		label VR_SELF
EA81:C30000	JP 0000
...
EA96:D9		EXX
EA97:E5		PUSH HL
EA98:		label PUSH_ALL_HL
EA98:210000	LD HL, 0000
EA9B:C9		RET
EA9C:		label POP_ALL
EA9C:E1		POP HL
EA9D:D9		EXX
...
EAAC:E3		EX (SP), HL
EAAD:C9		RET
EAAE:		label TIME_SCROLL
EAAE:3A795C	LD A, (5C79)
EAB1:E602	AND 02
EAB3:47		LD B, A
EAB4:		label TIME_SCROLL_LAST
EAB4:EE00	XOR 00
EAB6:C8		RET Z
EAB7:78		LD A, B
EAB8:32B5EA	LD (EAB5), A
EABB:CD3CE4	CALL E43C
EABE:C9		RET
EABF:		label PREHOD_PREPINAC
EABF:CD01E8	CALL E801
EAC2:CA15EB	JP Z, EB15
EAC5:47		LD B, A
EAC6:04		INC B
EAC7:21FDD6	LD HL, D6FD
EACA:4E		LD C, (HL)
EACB:CD29EA	CALL EA29
EACE:DD21D8DB	LD IX, DBD8
EAD2:C25FE4	JP NZ, E45F
EAD5:3E11	LD A, 11
EAD7:90		SUB B
EAD8:E5		PUSH HL
EAD9:CCA2EB	CALL Z, EBA2
EADC:05		DEC B
EADD:CD0CE8	CALL E80C
EAE0:1A		LD A, (DE)
EAE1:EB		EX DE, HL
EAE2:71		LD (HL), C
EAE3:E1		POP HL
EAE4:77		LD (HL), A
EAE5:C5		PUSH BC
EAE6:CDBFE4	CALL E4BF
EAE9:C1		POP BC
EAEA:2AFDD6	LD HL, (D6FD)
EAED:7C		LD A, H
EAEE:D61B	SUB 1B
EAF0:DABEE8	JP C, E8BE
EAF3:26EB	LD H, EB
EAF5:C611	ADD A, 11
EAF7:6F		LD L, A
EAF8:46		LD B, (HL)
EAF9:2A45D4	LD HL, (D445)
EAFC:CB48	BIT 1, B
EAFE:C47DE3	CALL NZ, E37D
EB01:7C		LD A, H
EB02:80		ADD A, B
EB03:67		LD H, A
EB04:79		LD A, C
EB05:B7		OR A
EB06:F5		PUSH AF
EB07:C400E5	CALL NZ, E500
EB0A:F1		POP AF
EB0B:CC2CE5	CALL Z, E52C
EB0E:C3BEE8	JP E8BE
EB11:		label PP_DATA
EB11:03000201	DEFB of 4 bytes
EB15:		label PP_DATA_END
		IF (false)
-     .error 'PP_DATA!'
		ENDIF
EB15:		label PP_NEJSME_V_INVENTARI
EB15:CD7DE3	CALL E37D
EB18:3E00	LD A, 00
EB1A:81		ADD A, C
EB1B:47		LD B, A
EB1C:CDC9E4	CALL E4C9
EB1F:		label PP_NALEZEN_OBJEKT
EB1F:C0		RET NZ
EB20:1A		LD A, (DE)
EB21:E61F	AND 1F
EB23:B8		CP B
...
EB26:E61C	AND 1C
EB28:FE0C	CP 0C
EB2A:CC74E4	CALL Z, E474
EB2D:CDCCE4	CALL E4CC
EB30:18ED	JR EB1F
EB32:		label PP_PROHOD_PAKU
		IF (false)
-     ld      A, (DE)                     ;  7:1 typ
...
-     ld      (de),a                      ;  7:1 typ
		ELSE (true)
EB32:2680	LD H, 80
EB34:CD54E5	CALL E554
		ENDIF
EB37:13		INC DE
EB38:CD86E4	CALL E486
EB3B:		label PP_LOOP
EB3B:13		INC DE
EB3C:1A		LD A, (DE)
EB3D:B7		OR A
...
EB43:1A		LD A, (DE)
EB44:67		LD H, A
EB45:CD54E5	CALL E554
EB48:C33BEB	JP EB3B
EB4B:		label HELP
EB4B:DD2162DE	LD IX, DE62
EB4F:3E02	LD A, 02
EB51:CD61E4	CALL E461
EB54:CD5FE4	CALL E45F
EB57:CD5FE4	CALL E45F
EB5A:CD5FE4	CALL E45F
EB5D:C9		RET
EB5E:		label OBAL_SPRITE2BUFFER
EB5E:F5		PUSH AF
EB5F:E5		PUSH HL
EB60:D5		PUSH DE
EB61:CD91E0	CALL E091
EB64:D1		POP DE
EB65:E1		POP HL
EB66:F1		POP AF
EB67:C9		RET
EB68:		label AKTUALIZUJ_RUZICI
EB68:3A46D4	LD A, (D446)
EB6B:87		ADD A, A
EB6C:87		ADD A, A
EB6D:C6C9	ADD A, C9
EB6F:6F		LD L, A
...
EB70:26D4	LD H, D4
		ENDIF
EB72:CDD4E7	CALL E7D4
EB75:C9		RET
EB76:		label AKTUALIZUJ_SIPKY
EB76:C5		PUSH BC
EB77:E5		PUSH HL
EB78:6F		LD L, A
EB79:CD6EE0	CALL E06E
EB7C:7D		LD A, L
EB7D:21A9D4	LD HL, D4A9
EB80:CDD4E7	CALL E7D4
EB83:85		ADD A, L
EB84:6F		LD L, A
		IF (false)
...
-     ld      H, A                        ; 4:1 H + carry
		ENDIF
EB85:CDD4E7	CALL E7D4
EB88:CD5DE0	CALL E05D
EB8B:E1		POP HL
EB8C:C1		POP BC
EB8D:C9		RET
		IF (false)
...
EBA2:		label EATING
EBA2:C5		PUSH BC
EBA3:3A72D4	LD A, (D472)
EBA6:CDB4EC	CALL ECB4
EBA9:23		INC HL
EBAA:46		LD B, (HL)
EBAB:115ADC	LD DE, DC5A
EBAE:79		LD A, C
EBAF:D61B	SUB 1B
EBB1:200D	JR NZ, EBC0
EBB3:1166DC	LD DE, DC66
EBB6:2B		DEC HL
EBB7:7E		LD A, (HL)
EBB8:C614	ADD A, 14
EBBA:B8		CP B
...
EBBE:77		LD (HL), A
EBBF:AF		XOR A
EBC0:		label E_NO_FOOD
EBC0:3D		DEC A
EBC1:2002	JR NZ, EBC5
EBC3:2B		DEC HL
EBC4:70		LD (HL), B
EBC5:		label E_NO_R
EBC5:3D		DEC A
EBC6:2002	JR NZ, EBCA
EBC8:23		INC HL
EBC9:77		LD (HL), A
EBCA:		label E_NO_G
EBCA:3D		DEC A
EBCB:2000	JR NZ, EBCD
EBCD:		label E_NO_B
EBCD:		label E_PRINT
EBCD:EB		EX DE, HL
EBCE:79		LD A, C
EBCF:CDA6E4	CALL E4A6
EBD2:C1		POP BC
EBD3:0E00	LD C, 00
EBD5:C9		RET
EBD6:		label FILL_ATTR_BLOCK
EBD6:50		LD D, B
EBD7:1E07	LD E, 07
EBD9:0601	LD B, 01
EBDB:CD8EEB	CALL EB8E
EBDE:25		DEC H
EBDF:CDEAEB	CALL EBEA
EBE2:1E00	LD E, 00
EBE4:0608	LD B, 08
EBE6:CD8EEB	CALL EB8E
EBE9:C9		RET
		ENDIF
EBEA:		label SEG_ATTR2SCREEN
EBEA:7C		LD A, H
EBEB:26B0	LD H, B0
EBED:D6C8	SUB C8
EBEF:3004	JR NC, EBF5
EBF1:2640	LD H, 40
EBF3:C670	ADD A, 70
EBF5:		label SA_BUFF
EBF5:87		ADD A, A
...
EBF9:67		LD H, A
EBFA:C9		RET
EBFB:		label ZOBRAZ_ZIVOTY
EBFB:215BD7	LD HL, D75B
EBFE:0606	LD B, 06
EC00:		label ZZ_LOOP
EC00:C5		PUSH BC
EC01:4E		LD C, (HL)
...
EC07:2C		INC L
EC08:56		LD D, (HL)
EC09:CD4DEC	CALL EC4D
EC0C:2C		INC L
EC0D:4E		LD C, (HL)
EC0E:2C		INC L
EC0F:3A785C	LD A, (5C78)
EC12:B9		CP C
EC13:3802	JR C, EC17
EC15:AF		XOR A
EC16:77		LD (HL), A
EC17:		label ZZ_NEVYPRSEL
EC17:7E		LD A, (HL)
EC18:B7		OR A
EC19:2804	JR Z, EC1F
EC1B:47		LD B, A
EC1C:CD27EC	CALL EC27
EC1F:		label ZZ_BEZ_AKT_ZRANENI
EC1F:2C		INC L
EC20:C1		POP BC
EC21:10DD	DJNZ EC00
EC23:C9		RET
EC24:		label FLEK_Y
EC24:80		DEFB of 1 bytes
EC25:69		DEFB of 1 bytes
EC26:52		DEFB of 1 bytes
EC27:		label FLEK_Y_END
...
EC35:47		LD B, A
EC36:D5		PUSH DE
EC37:116770	LD DE, 7067
EC3A:CD5EEB	CALL EB5E
EC3D:E1		POP HL
EC3E:2C		INC L
EC3F:2C		INC L
EC40:DD214BEC	LD IX, EC4B
EC44:3E42	LD A, 42
EC46:CDEEE3	CALL E3EE
EC49:E1		POP HL
EC4A:C9		RET
EC4B:		label DAMAGE_BUF
EC4B:3100	DEFB of 2 bytes
EC4D:		label VYKRESLI_ZIVOTY
EC4D:E5		PUSH HL
EC4E:D5		PUSH DE
EC4F:D5		PUSH DE
EC50:AF		XOR A
...
EC5B:0D		DEC C
EC5C:ED52	SBC HL, DE
EC5E:30FB	JR NC, EC5B
EC60:ED5A	ADC HL, DE
EC62:29		ADD HL, HL
EC63:29		ADD HL, HL
EC64:29		ADD HL, HL
EC65:		label VZ_ZBYTEK
EC65:3C		INC A
EC66:ED52	SBC HL, DE
EC68:30FB	JR NC, EC65
		IF (false)
...
EC70:79		LD A, C
EC71:3C		INC A
EC72:2002	JR NZ, EC76
EC74:3E42	LD A, 42
EC76:		label VZ_VICEZNAKOVY
EC76:E646	AND 46
EC78:5F		LD E, A
EC79:E1		POP HL
EC7A:0605	LD B, 05
EC7C:		label VZ_LOOP_SELF
EC7C:7A		LD A, D
EC7D:0C		INC C
EC7E:2803	JR Z, EC83
EC80:79		LD A, C
EC81:17		RLA
EC82:9F		SBC A, A
EC83:		label VZ_PREDEL
EC83:		label VZ_COL_SELF
EC83:73		LD (HL), E
EC84:E5		PUSH HL
EC85:C5		PUSH BC
EC86:4F		LD C, A
EC87:CDEAEB	CALL EBEA
EC8A:0606	LD B, 06
EC8C:		label VZ_LOOP_PX
EC8C:24		INC H
EC8D:71		LD (HL), C
EC8E:10FC	DJNZ EC8C
EC90:C1		POP BC
...
EC96:E1		POP HL
EC97:C9		RET
EC98:		label VYHAZEJ_VSECHNO
EC98:C5		PUSH BC
EC99:D5		PUSH DE
EC9A:7B		LD A, E
EC9B:061B	LD B, 1B
EC9D:CD10E8	CALL E810
ECA0:		label VV_LOOP
		IF (false)
...
ECA1:D5		PUSH DE
ECA2:C5		PUSH BC
ECA3:2A45D4	LD HL, (D445)
ECA6:1A		LD A, (DE)
ECA7:B7		OR A
ECA8:C400E5	CALL NZ, E500
ECAB:C1		POP BC
ECAC:D1		POP DE
ECAD:AF		XOR A
ECAE:12		LD (DE), A
...
ECBC:26D7	LD H, D7
ECBE:C9		RET
ECBF:		label ZRAN_POSTAVU
ECBF:D5		PUSH DE
ECC0:7B		LD A, E
ECC1:CDB4EC	CALL ECB4
ECC4:7E		LD A, (HL)
ECC5:92		SUB D
ECC6:3007	JR NC, ECCF
ECC8:AF		XOR A
ECC9:77		LD (HL), A
ECCA:CD98EC	CALL EC98
ECCD:180E	JR ECDD
ECCF:		label ZP_ZIJE
ECCF:77		LD (HL), A
ECD0:23		INC HL
...
ECDD:D1		POP DE
ECDE:C9		RET
ECDF:		label OTESTUJ_TRVALE_ZRANENI
ECDF:D5		PUSH DE
ECE0:7B		LD A, E
ECE1:CDB4EC	CALL ECB4
ECE4:23		INC HL
ECE5:23		INC HL
ECE6:7E		LD A, (HL)
ECE7:B7		OR A
ECE8:57		LD D, A
ECE9:C4BFEC	CALL NZ, ECBF
ECEC:D1		POP DE
ECED:C9		RET
ECEE:		label PLAYERS_WINDOW_AND_DAMAGE
ECEE:		label PWAD_SELF
ECEE:3E00	LD A, 00
ECF0:21785C	LD HL, 5C78
ECF3:AE		XOR (HL)
ECF4:E680	AND 80
ECF6:280F	JR Z, ED07
ECF8:7E		LD A, (HL)
ECF9:32EFEC	LD (ECEF), A
ECFC:110001	LD DE, 0100
ECFF:0606	LD B, 06
ED01:		label PWAD_LOOP
ED01:CDDFEC	CALL ECDF
ED04:1C		INC E
ED05:10FA	DJNZ ED01
ED07:		label PWAD_NEZRANUJ
ED07:CD31E8	CALL E831
ED0A:C9		RET
ED0B:		label BUFF2SCREEN
ED0B:CD84EA	CALL EA84
ED0E:AF		XOR A
ED0F:D3FE	OUT (FE), A
ED11:2100C8	LD HL, C800
ED14:227AED	LD (ED7A), HL
ED17:76		HALT
ED18:F3		DI
ED19:210602	LD HL, 0206
ED1C:		label B2S_WAIT
ED1C:2B		DEC HL
ED1D:7C		LD A, H
ED1E:B5		OR L
ED1F:20FB	JR NZ, ED1C
ED21:4D		LD C, L
ED22:39		ADD HL, SP
ED23:22B9ED	LD (EDB9), HL
ED26:0608	LD B, 08
ED28:2110B0	LD HL, B010
ED2B:1804	JR ED31
ED2D:		label B2S_PIXEL_DOWN_LOOP
ED2D:211071	LD HL, 7110
ED30:		label B2S_CHAR_DOWN_LOOP
ED30:39		ADD HL, SP
ED31:		label B2S_DIRECT
ED31:F9		LD SP, HL
ED32:F1		POP AF
ED33:D1		POP DE
ED34:E1		POP HL
...
ED4D:D5		PUSH DE
ED4E:F5		PUSH AF
ED4F:ED7364ED	LD (ED64), SP
ED53:21F06F	LD HL, 6FF0
ED56:39		ADD HL, SP
ED57:F9		LD SP, HL
ED58:F1		POP AF
ED59:D1		POP DE
...
ED61:C1		POP BC
ED62:F1		POP AF
ED63:		label B2S_SELF_DIRECT
ED63:310000	LD SP, 0000
ED66:F5		PUSH AF
ED67:C5		PUSH BC
ED68:D5		PUSH DE
ED69:E5		PUSH HL
...
ED70:F5		PUSH AF
ED71:10BA	DJNZ ED2D
ED73:ED73A0ED	LD (EDA0), SP
ED77:0602	LD B, 02
ED79:		label B2S_ATTR_LOOP
ED79:		label B2S_SELF_SRC
ED79:3100C8	LD SP, C800
ED7C:F1		POP AF
ED7D:D1		POP DE
ED7E:E1		POP HL
ED7F:D9		EXX
...
ED85:D1		POP DE
ED86:C1		POP BC
ED87:210290	LD HL, 9002
ED8A:39		ADD HL, SP
ED8B:F1		POP AF
ED8C:ED737AED	LD (ED7A), SP
ED90:F9		LD SP, HL
ED91:F5		PUSH AF
ED92:C5		PUSH BC
ED93:D5		PUSH DE
...
ED9C:F5		PUSH AF
ED9D:10DA	DJNZ ED79
ED9F:		label B2S_ATTR_SELF
ED9F:310000	LD SP, 0000
EDA2:0C		INC C
EDA3:213069	LD HL, 6930
EDA6:79		LD A, C
EDA7:FE14	CP 14
EDA9:280D	JR Z, EDB8
EDAB:0608	LD B, 08
EDAD:E607	AND 07
EDAF:C230ED	JP NZ, ED30
EDB2:213070	LD HL, 7030
EDB5:C330ED	JP ED30
EDB8:		label B2S_EXIT
EDB8:		label B2S_SELF
EDB8:310000	LD SP, 0000
EDBB:FB		EI
EDBC:CD9CEA	CALL EA9C
EDBF:C9		RET
		INCLUDE table.h
i_nw		EQU 0000
i_ne		EQU 0001
...
EDC0:		label ADR_ZARAZKY
EDC0:DCEE	DEFW of 1 words
EDC2:		label TABLE_OBJECTS
EDC2:010C00	DEFB of 3 bytes
EDC5:060C01	DEFB of 3 bytes
EDC8:101019	DEFB of 3 bytes
EDCB:101114	DEFB of 3 bytes
EDCE:101219	DEFB of 3 bytes
EDD1:101316	DEFB of 3 bytes
EDD4:11101A	DEFB of 3 bytes
EDD7:111117	DEFB of 3 bytes
EDDA:11120A	DEFB of 3 bytes
EDDD:11130B	DEFB of 3 bytes
EDE0:158980	DEFB of 3 bytes
EDE3:201015	DEFB of 3 bytes
EDE6:201113	DEFB of 3 bytes
EDE9:201218	DEFB of 3 bytes
EDEC:201311	DEFB of 3 bytes
EDEF:21100C	DEFB of 3 bytes
EDF2:211106	DEFB of 3 bytes
EDF5:211207	DEFB of 3 bytes
EDF8:211317	DEFB of 3 bytes
EDFB:301019	DEFB of 3 bytes
EDFE:321204	DEFB of 3 bytes
EE01:321302	DEFB of 3 bytes
EE04:40101A	DEFB of 3 bytes
EE07:40111A	DEFB of 3 bytes
EE0A:40121A	DEFB of 3 bytes
EE0D:40131A	DEFB of 3 bytes
EE10:421010	DEFB of 3 bytes
EE13:42111C	DEFB of 3 bytes
EE16:42121D	DEFB of 3 bytes
EE19:42131E	DEFB of 3 bytes
EE1C:448980	DEFB of 3 bytes
EE1F:50101A	DEFB of 3 bytes
EE22:50111A	DEFB of 3 bytes
EE25:50121A	DEFB of 3 bytes
EE28:50131A	DEFB of 3 bytes
EE2B:521012	DEFB of 3 bytes
EE2E:521108	DEFB of 3 bytes
EE31:52121B	DEFB of 3 bytes
EE34:52131D	DEFB of 3 bytes
EE37:578401	DEFB of 3 bytes
EE3A:571016	DEFB of 3 bytes
EE3D:57101D	DEFB of 3 bytes
EE40:57101D	DEFB of 3 bytes
EE43:57101D	DEFB of 3 bytes
EE46:578500	DEFB of 3 bytes
EE49:578700	DEFB of 3 bytes
EE4C:57131A	DEFB of 3 bytes
EE4F:571311	DEFB of 3 bytes
EE52:590100	DEFB of 3 bytes
EE55:005784	DEFB of 3 bytes
EE58:5F0C00	DEFB of 3 bytes
EE5B:738C00	DEFB of 3 bytes
EE5E:73121D	DEFB of 3 bytes
EE61:778401	DEFB of 3 bytes
EE64:778500	DEFB of 3 bytes
EE67:778700	DEFB of 3 bytes
EE6A:810C01	DEFB of 3 bytes
EE6D:840200	DEFB of 3 bytes
EE70:007784	DEFB of 3 bytes
EE73:8E8400	DEFB of 3 bytes
EE76:8E8400	DEFB of 3 bytes
EE79:8E8600	DEFB of 3 bytes
EE7C:9EE400	DEFB of 3 bytes
EE7F:9EE400	DEFB of 3 bytes
EE82:9EE600	DEFB of 3 bytes
EE85:B00C00	DEFB of 3 bytes
PAKA_A		EQU 00B9
PAKA_B		EQU 00BA
PAKA_C		EQU 00BB
PAKA_D		EQU 00BC
EE88:B90200	DEFB of 3 bytes
EE8B:008E84	DEFB of 3 bytes
EE8E:009EE4	DEFB of 3 bytes
EE91:00BA82	DEFB of 3 bytes
EE94:00BB82	DEFB of 3 bytes
EE97:00BC82	DEFB of 3 bytes
EE9A:BA0200	DEFB of 3 bytes
EE9D:009EC4	DEFB of 3 bytes
EEA0:00BB82	DEFB of 3 bytes
EEA3:BB0200	DEFB of 3 bytes
EEA6:009E64	DEFB of 3 bytes
EEA9:00BC82	DEFB of 3 bytes
EEAC:BC0200	DEFB of 3 bytes
EEAF:009EA4	DEFB of 3 bytes
EEB2:00BA82	DEFB of 3 bytes
EEB5:D80100	DEFB of 3 bytes
		IF (false)
- defb      0,                           216,      ZAM_1 + TYP_PREPINAC + west    ; prepne i paku na druhe strane
		ENDIF
EEB8:00E884	DEFB of 3 bytes
EEBB:D80300	DEFB of 3 bytes
		IF (false)
- defb      0,                           216,      ZAM_1 + TYP_PREPINAC + east    ; prepne i paku na druhe strane
		ENDIF
EEBE:00E884	DEFB of 3 bytes
EEC1:E88401	DEFB of 3 bytes
EEC4:E88500	DEFB of 3 bytes
EEC7:E88700	DEFB of 3 bytes
EECA:F60C01	DEFB of 3 bytes
EECD:F6101D	DEFB of 3 bytes
EED0:F6111C	DEFB of 3 bytes
EED3:F6121D	DEFB of 3 bytes
EED6:F6131D	DEFB of 3 bytes
EED9:FE0C00	DEFB of 3 bytes
EEDC:		label ZARAZKA
EEDC:FF		DEFB of 1 bytes
		End of INCLUDE
EEDD:		label END_CODE
		IF (false)
-     .error 'Kod preteka do zasobniku.'
		ENDIF
Emiting raw binary from 5F00 to EEDC
